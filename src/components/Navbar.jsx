        ...
        <div className="relative flex h-20 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              <Link to="/" className="flex items-center">
                <span className="text-white text-4xl font-bold">FitLife</span>
              </Link>
            </div>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex h-12 w-12 rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-3 hover:ring-white focus:ring-white focus:ring-offset-1 focus:ring-offset-gray-800 cursor-pointer">
